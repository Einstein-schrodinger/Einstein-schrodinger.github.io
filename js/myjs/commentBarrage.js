...
const commentBarrageConfig = {
    ...
    lightColors:[
        ['var(--sqw-white-acrylic2)','var(--sqw-black)'],
    ],
    darkColors:[
        ['var(--sqw-black-acrylic2)','var(--sqw-white)'],
    ],
    //同时最多显示弹幕数
    maxBarrage: 1,
    //弹幕显示间隔时间，单位ms
    ...
    twikooUrl: "https://twikoo.sqwdream.cloud/",
    //token获取见前文
    accessToken: "1f955e360afce8c92ccc1d67d533a414",
